...
function Login() {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            localStorage.setItem('usuarioQRCode', JSON.stringify(usuario));
            ...
            setSenha('');
            setTimeout(() => {
                window.location.href = '/qrcode-reader';
            }, 1000);
        } catch (error) {
            ...
            <div className='app-container'>
                ...
                <main>
                    <form className="container-form" onSubmit={handleLogin}>
                        <img src='/images/qrcode_vazio.png' style={{ width: '20vh', margin: '0 auto' }} />
                        <p className="descricao">Entre para usar o Escaner Crácha Digital!</p>
